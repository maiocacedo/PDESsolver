...
# Animação
PDES1.visualize(mode='animation1d', func_idx=0, tf=1.0, interval=5)
PDES1.visualize(mode='animation1d', func_idx=1, tf=1.0, interval=5)
PDES1.visualize(mode='animation1d', func_idx=2, tf=1.0, interval=5)
PDES1.visualize(mode='animation1d', func_idx=3, tf=1.0, interval=5)